...
import HeroSlideMovie from "../components/common/HeroSlideMovie"; // Import movie HeroSlide
import HeroSlideTv from "../components/common/HeroSlideTv"; // Import TV HeroSlide
...
const MediaList = () => {
  ...
  return (
    <>
      {/* Conditionally render HeroSlideMovie or HeroSlideTv based on mediaType */}
      {mediaType === tmdbConfigs.mediaType.movie ? (
        <HeroSlideMovie mediaCategory={mediaCategories[currCategory]} />
      ) : (
        <HeroSlideTv mediaCategory={mediaCategories[currCategory]} />
      )}
