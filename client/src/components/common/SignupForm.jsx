...
const SignupForm = ({ switchAuthState }) => {
  ...
  const signinForm = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      phoneNo : Yup.number()
        .min(10, "Phone no. minimum 10 charactes")
    ...
    <Box component="form" onSubmit={signinForm.handleSubmit}>
      <Stack spacing={3}>
        ...
        <TextField
          ...
          name="phoneNo"  // Note: ensure "phoneNo" here matches with your formik state
          fullWidth
          value={signinForm.values.phoneNo}
          onChange={signinForm.handleChange}
          color="success"
          error={signinForm.touched.phoneNo && signinForm.errors.phoneNo !== undefined}
          helperText={signinForm.touched.phoneNo && signinForm.errors.phoneNo}
        />
        <TextField
          type="password"
